 ...
 */
    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if ("email" === formRequiredItem.dataset.required) {
                    ...
                    this.addError(formRequiredItem);
                    error++;
                } else if ("name" === formRequiredItem.dataset.required) if ("string" === typeof formRequiredItem.value && formRequiredItem.value.match(/^([а-яё][А-ЯЁ]+)$/i)) this.removeError(formRequiredItem); else {
                    this.addError(formRequiredItem);
                    error++;
                ...
                if (0 === error) {
                    ...
                    if (ajax) {
                        ...
                        if (response.ok) {
                            ...
                            if (4 == responseResult["code"]) {
                                let sale__code = document.querySelector(".sale__code");
                                sale__code.innerHTML = `${responseResult["message"]}`;
                                sale__code.classList.add("_move");
                            }
                            if (5 == responseResult["code"]) {
                                let sale__code = document.querySelector(".sale__code");
                                sale__code.innerHTML = `${responseResult["message"]}`;
                                sale__code.classList.add("_move");
                            }
        ...
        const inputMasks = document.querySelector("input._phone");
        if (inputMasks) {
            inputMasks.classList.add("_mask");
